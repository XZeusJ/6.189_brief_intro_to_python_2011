...
class Shape():
    ...
    def can_move(self, board, dx, dy):
        ...
        flag = True
        for block in self.blocks:
            flag = flag and block.can_move(board, dx, dy)
        return flag
    ...
    def can_rotate(self, board):
        ...
        for block in self.blocks:
            ...
            if block.can_move(board,dx,dy) == False: return False
        return True
    ...
    def rotate(self, board):
        ...
        rot_dir = self.get_rotation_dir()
        center  = self.center_block
        # print [(b.x,b.y) for b in self.blocks]
        for block in self.blocks:
...
class Board():
    ...
    def can_move(self, x, y):
        ...
        #2
        if self.grid.has_key((x,y)): return False
    ...
    def delete_row(self, y):
        ...
        #YOUR CODE HERE
        # print "before delete, the grid looks like", self.grid.keys()
        ...
        # print "after delete, the grid looks like", self.grid.keys()
    ...
    def is_row_complete(self, y):        
        ...
        for col in range(self.width):
            flag = flag and self.grid.has_key((col, y))
        return flag
    ...
    def move_down_rows(self, y_start):
        ...
        #YOUR CODE HERE
        # print "before move, the grid looks like ", self.grid.keys()

        for x in range(self.width):
            for y in range(y_start, 0, -1): #that's fabulous
                if self.grid.has_key((x, y)):
                    # print "we now want to move down (",x,y,")"
                    block = self.grid[(x, y)]
                    del self.grid[(x, y)]
                    block.move(0,1)
                    self.grid[(block.x, block.y)] = block
    
        # print "after move, the grid looks like ", self.grid.keys()
    ...
    def game_over(self):
        ...
        #YOUR CODE HERE
        pos_x = self.width/2 * Block.BLOCK_SIZE
        pos_y = self.height/2* Block.BLOCK_SIZE
        msg = Text( Point(pos_x, pos_y), "GAME OVER!!!")
...
class Tetris():
    ...
    def create_new_shape(self):
        ...
        new_shape = self.SHAPES[index]

        x = int(self.BOARD_WIDTH/2)
        y = 0

        return new_shape(Point(x, y))
